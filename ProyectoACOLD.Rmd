...
de las variables tal y como se especifica en la documentación de la libreria.
...
Antes de llevar a cabo la eliminación de alguna variable, vamos a realizar un estudio
de correlación entre las variables predictoras y la variable objetivo. Para ello, vamos
a convertir la variable V16, que representa un evento binario, a eventos probabilisticos.

Para ello, vamos a crear un modelo de regresión logístico. Comenzamos creando un modelo
de regresión generalizable cuyo error de distribución pertenece a la familia binomial y
la función especifica para modelarlo es logit (logaritmo de odds ratio).
