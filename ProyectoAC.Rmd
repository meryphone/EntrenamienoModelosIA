...
Para continuar, vamos a comenzar con el tratamiento de valores extremos y atípicos, para ello vamos a calcular
el valor limite superior e inferior para considerarlos atípicos. Vamos a repetir el cálculo con todas las 
variables númericas de la BBDD.
### Variable V2
```{r}
...
```
Como podemos ver, el limite inferior calculado es muy bajo. Al realizar un boxplot para comprobar los
cálculos vemos como el límite inferior dado por el boxplot es 13.75 debido a que es el valor más
bajo de la variable.
### Variable V3
```{r}
