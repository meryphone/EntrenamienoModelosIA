...
Como podemos comprobar hemos aplicado el escalado correctamente, el obtener valores
negativos es completamente normal al aplicar este tipo de escalado. Esto es debido a
...
muy sesgada positivamente. Por lo tanto, vamos a realizar una normalización logarítmica
...
Aplicamos la normalización logarítmica para las variables mencionadas.
