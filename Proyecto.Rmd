...
La matriz de confusión del modelo KNN muestra una precisión del 78.1%,
lo que significa que el modelo acertó en la mayoría de las predicciones,
pero todavía tiene margen de mejora. La sensibilidad es de 88.2%,
indicando que el modelo identifica bien las instancias positivas,
mientras que la especificidad es de 65.6%, lo que sugiere que tiene más
dificultades en identificar correctamente las instancias negativas. El
valor Kappa de 0.548 indica un acuerdo moderado entre las predicciones y
los valores reales. En general, el modelo es bastante bueno en predecir
la clase positiva, aunque tiene menos precisión con la clase negativa.
...
conseguimos obtener. Vamos a aplicar una grid search enfocada en buscar
combinaciones de hiperparámetros cercanas a la elegida automáticamente
por el modelo para intentar conseguir mejor rendimiento.
