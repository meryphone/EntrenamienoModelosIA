...
tuneGrid <- expand.grid(
  size = c(6, 8, 10),          # Prueba valores mayores
  decay = c(0.001, 0.005, 0.01) # Valores más pequeños
)
...
set.seed(1234)
modelo_nnet <- train(
  V16 ~ .,                        # Fórmula: variable dependiente vs independientes
  ...
  trace = FALSE,                  # No mostrar progreso interno de nnet
