...
Como podemos ver, hemos mejorado tanto la precisión como la kappa. Para intentar mejorarlo aún más vamos a proceder a aplicar otro tipo distinto de normalización al que ya habíamos probado anteriormente. Vamos a realizar una normalización $BoxCox$, que además ayuda a reducir el sesgo de las variables.
